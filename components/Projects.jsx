...
const Projects = () => {
    return (<div id="projects" className="purple">
        ...
        <div className="projects-container flex-disp">
            ...
            <Project href="https://google-search-ashy.vercel.app/search" src="/images/Google.jpg" alt="Search website" tech="ReactJS, Tailwind.css, Rapid API"/>
            <Project href="https://superquiz.great-site.net" src="/images/quiz.jpg" alt="Quiz website" tech="JavaScript, HTML, CSS"/>
            <Project href="https://blog-next-graph-ql.vercel.app/" src="/images/blog.jpg" alt="Search website" tech="ReactJS, Next.js, GRaphQL, Hygraph cms"/>
