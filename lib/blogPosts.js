...
export const BLOG_POSTS = [
  {
    slug: "teaching-ai-to-cheat-the-judge-that-didnt-care-about-the-score",
    title: "Teaching an AI to Cheat (On Purpose): The Judge That Didn't Care About the Score",
    date: "June 28, 2026",
    isoDate: "2026-06-28",
    readTime: "7 min read",
  ...
  {
    slug: "teaching-ai-to-cheat-the-dial-vs-the-wall",
    title: "Teaching an AI to Cheat (On Purpose): The Dial Versus the Wall",
    date: "June 27, 2026",
    isoDate: "2026-06-27",
    readTime: "7 min read",
    category: "Machine Learning",
  ...
  {
    slug: "teaching-ai-to-cheat-the-detector-that-saw-what-the-other-missed",
    title: "Teaching an AI to Cheat (On Purpose): The Detector That Saw What the Other One Missed",
    date: "June 26, 2026",
    isoDate: "2026-06-26",
    readTime: "7 min read",
    category: "Machine Learning",
  ...
  {
    slug: "teaching-ai-to-cheat-finding-the-detector-floor",
    title: "Teaching an AI to Cheat (On Purpose): Finding Where the Detector Breaks",
    date: "June 25, 2026",
    isoDate: "2026-06-25",
    readTime: "7 min read",
    category: "Machine Learning",
  ...
  {
    slug: "teaching-ai-to-cheat-reward-hacking-results",
    title: "Teaching an AI to Cheat (On Purpose): What Happened",
    date: "June 24, 2026",
    isoDate: "2026-06-24",
    readTime: "7 min read",
    category: "Machine Learning",
  ...
  {
    slug: "reward-hacking-detector-build",
    title: "Teaching an AI to Cheat (On Purpose): What I Built",
    date: "June 24, 2026",
    isoDate: "2026-06-24",
    readTime: "8 min read",
    category: "Machine Learning",
    image: "/images/blogs/research.png",
    description:
      "A piece-by-piece build log for the reward-tampering gridworld project: a custom Gymnasium environment, three PPO agents trained with different incentives, a behavior-based cheat detector, and a local LLM critic that explains the violations.",
  },
  {
